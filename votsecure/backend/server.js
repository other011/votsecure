...
app.use(cors({
  origin: ["http://localhost:5173", "http://localhost:3000", process.env.CORS_ORIGIN, "https://votsecure-production.up.railway.app", "https://impartial-emotion-production-071b.up.railway.app"].filter(Boolean),
}));
